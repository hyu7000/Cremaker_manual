...
.. image:: /images/InstallCura/temp.png
   :width: 500

|
| :blackcircle:`※` 큐라 5.2.1 이상인 경우에 약간의 설정 오류가 있습니다. 설정 항목중 '첫번째 레이어의 프린팅 온도'를 215로 변경해줍니다.
| 설정항목이 보이지 않는다면, 메뉴 - 설정 - 설정보기에서 활성화할 수 있습니다.
