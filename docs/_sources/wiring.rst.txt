...
| :orangecircle:`●` 모터선 정리는 케이블 캡-1(a)에 모터선을 넣고 프로파일 안쪽 홈에 고정합니다.
| :bluecircle:`●` 케이블 캡-1(a)로 Z 모터의 모터선을 XY프로파일에 끼워줍니다.
| :orangecircle:`●` Z 모터선 2개를 사진과 같이 XY 프로파일 아래로 빠져나오도록 합니다.
| :skybluecircle:`●` 케이블들을 정리하여 파워 뒷면에 케이블 타이로 묶어줍니다.
...
| :bluecircle:`●` 노즐 아랫부분에서 노즐 열선을 찾습니다. 노즐 열선은 빨간 선입니다.
...
| ※ 볼트로 디스플레이를 고정할 때에는 세게 조이면, 디스플레이 터치가 인식하지 못할 수 있으니 너무 세게 조여지지 않도록 합니다.
